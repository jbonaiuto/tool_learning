...
output_path=fullfile(exp_info.base_output_dir, 'HMM', 'betta', 'motor_grasp','FO_FALSE',...
    '10w_multiday_condHMM', array);
...
% Fit the model
system(sprintf('"C:/Program Files/R/R-3.6.1/bin/Rscript" ../../../R/hmm/fit_condition_covar.R "%s"', strrep(output_path,'\','/')));
