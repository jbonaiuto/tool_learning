...
xlabel('Time (ms)');
xlim(win_size);
xline(0,'--r','go signal','LabelHorizontalAlignment','left','LabelOrientation','horizontal', 'LineWidth', 1.25);
xline(HandMvtOnset_time,'--r','hand mvt onset','LabelHorizontalAlignment','left','LabelOrientation','horizontal', 'LineWidth', 1.25);
xline(contact_time,'--r','contact','LabelHorizontalAlignment','left','LabelOrientation','horizontal', 'LineWidth', 1.25);
xline(place_time,'--r','place','LabelHorizontalAlignment','left','LabelOrientation','horizontal', 'LineWidth', 1.25);
