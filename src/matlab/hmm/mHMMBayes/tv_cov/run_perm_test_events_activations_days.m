function run_perm_test_events_activations_days(subject, data, model)
...
if strcmp(subject,'betta')
    included={'1 - rt', '3 - reach_dur', '4 - reach_dur', '6 - reach_dur', '1 - place_dur','4 - place_dur','6 - place_dur' };
elseif strcmp(subject,'samovar')
    included={'1 - rt', '2 - rt', '2 - reach_dur', '3 - reach_dur', '4 - reach_dur','5 - reach_dur','2 - place_dur','3 - place_dur','5 - place_dur' };
end
figure();
lbls={};
hold all;
