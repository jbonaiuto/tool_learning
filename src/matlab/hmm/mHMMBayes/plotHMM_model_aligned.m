function aligned_p_states=plotHMM_model_aligned(data, date, conditions, array, model)
...
saveas(f,fullfile(exp_info.base_output_dir,'HMM', 'betta', 'grasp','50_models','model_aligned', [date '_' array '_aligned_grasp.png']));
saveas(f,fullfile(exp_info.base_output_dir,'HMM', 'betta', 'grasp','50_models','model_aligned', [date '_' array '_aligned_grasp.eps']), 'epsc');
close(f);
end