...
saveas(f,fullfile(exp_info.base_output_dir,'HMM', 'betta', 'grasp','10w_centerHMM', [date '_' array '_centerHMM_grasp.png']));
saveas(f,fullfile(exp_info.base_output_dir,'HMM', 'betta', 'grasp','10w_centerHMM',[date '_' array '_centerHMM_grasp.eps']), 'epsc');
close(f);
end