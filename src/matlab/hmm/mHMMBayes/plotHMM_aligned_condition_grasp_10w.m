function aligned_p_states=plotHMM_aligned_condition_grasp_10w(data, file_prefix, conditions, array, forward_probs_file)
...
saveas(f,fullfile(exp_info.base_output_dir,'HMM', 'betta', 'grasp', [file_prefix '_' array '_condFR_grasp.png']));
saveas(f,fullfile(exp_info.base_output_dir,'HMM', 'betta', 'grasp', [file_prefix '_' array '_condFR_grasp.eps']), 'epsc');
close(f);
...
saveas(f,fullfile(exp_info.base_output_dir,'HMM', 'betta', 'grasp', [file_prefix '_' array '_condHMM_grasp.png']));
saveas(f,fullfile(exp_info.base_output_dir,'HMM', 'betta', 'grasp', [file_prefix '_' array '_condHMM_grasp.eps']), 'epsc');
close(f);
end