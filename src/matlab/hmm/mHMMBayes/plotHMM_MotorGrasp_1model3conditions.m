function aligned_p_states=plotHMM_MotorGrasp_1model3conditions(data, file_prefix, conditions, array, forward_probs_file)
...
saveas(f,fullfile(exp_info.base_output_dir,'HMM', 'betta', 'grasp','10w_HMM', [file_prefix '_' array '_3condFR_grasp.png']));
saveas(f,fullfile(exp_info.base_output_dir,'HMM', 'betta', 'grasp','10w_HMM', [file_prefix '_' array '_3condFR_grasp.eps']), 'epsc');
close(f);
...
saveas(f,fullfile(exp_info.base_output_dir,'HMM', 'betta', 'grasp','10w_HMM', [file_prefix '_' array '_3condHMM_grasp.png']));
saveas(f,fullfile(exp_info.base_output_dir,'HMM', 'betta', 'grasp','10w_HMM',[file_prefix '_' array '_3condHMM_grasp.eps']), 'epsc');
close(f);
end