...
monkey_camera_coord=M*inv(proj_mat*ex_mat*M)*[eyetracker_film_coord ones(size(eyetracker_film_coord,1),1)]';
monkey_camera_coord=monkey_camera_coord(1:3,:)./repmat(monkey_camera_coord(4,:),3,1);
...
table_coord=table_coord(1:3,:)./repmat(table_coord(4,:),3,1);
