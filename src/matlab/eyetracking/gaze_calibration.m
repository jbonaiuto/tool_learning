function gaze_calibration(exp_info, subject, date, plexon_data_path)
...
if length(files)>0
    ...
    plot(x_table(possible_monkey_tool_left_points),y_table(possible_monkey_tool_left_points),'.b');
