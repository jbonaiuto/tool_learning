...
% Find directory where raw data is stored
...
for x=1:length(intan_data_dirs)
    potential_data_dir=fullfile(intan_data_dirs{x},subject,recording_date);
    if exist(potential_data_dir,'dir')==7
        raw_data_dir=potential_data_dir;
        break
    end
end

if length(raw_data_dir)>0
