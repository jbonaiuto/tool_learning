...
stage2_dates={'27.03.19','28.03.19','29.03.19','01.04.19','02.04.19',...
    ...
    '23.04.19','24.04.19','25.04.19','26.05.19','29.04.19','01.05.19',...
    ...
    '04.07.19','05.07.19','08.07.19','09.07.19','10.07.19','11.07.19',...
...
stage3_dates={'11.09.19','12.09.19','13.09.19','16.09.19','17.09.19',...
    ...
    '26.09.19','27.09.19','27.09.19','30.09.19','03.10.19','04.10.19',...
    '07.10.19','08.10.19','09.10.19','10.10.19','11.10.19','14.10.19',...
    '16.10.19','17.10.19','18.10.19','21.10.19','22.10.19','23.10.19',...
    '24.10.19','25.10.19','28.10.19','29.10.19','30.10.19','31.10.19',...
    '04.11.19','05.11.19','06.11.19','14.11.19','20.11.19','21.11.19',...
    '22.11.19','25.11.19','26.11.19','05.12.19','09.12.19','16.12.19',...
...
for array_idx=1:length(exp_info.array_names)
    ...
    date_data={};
    for i=1:length(stage1_dates)
        load(fullfile(exp_info.base_data_dir, 'preprocessed_data', subject,...
            stage1_dates{i},'multiunit','binned',...
            sprintf('fr_b_%s_%s_whole_trial.mat',array,stage1_dates{i})));
        date_data{i}=data;
        clear('datafr');
    end
