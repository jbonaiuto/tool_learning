...
dates={'11.06.21','15.06.21','16.06.21','17.06.21','18.06.21','22.06.21','23.06.21','09.07.21','13.07.21','14.07.21','15.07.21',...
...
Behavior=table('Size',[days_nbr 39],'VariableTypes',{'string','double','double',...
...
Behavior.Properties.VariableNames={'date','ValidTrial','Left','Center','Right','Success nbr','Success','Thirds',...
    ...
    'SuccessMultipleAttempt_nbr','SuccessMultipleAttempt'};
...
for d=1:length(dates)
    ...
    Behavior(d,:)={DOI,validTrials_nbr,conditionLeft_nbr,conditionCenter_nbr,conditionRight_nbr,...
       ...
       MultipleAttempts_nbr,Success_MultipleAttempts_nbr,Success_MultipleAttempts_rate};
end
