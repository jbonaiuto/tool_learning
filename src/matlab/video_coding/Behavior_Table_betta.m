...
dates={'07.05.19','09.05.19','14.05.19','17.05.19','22.05.19','01.07.19','02.07.19','03.07.19','05.07.19','08.07.19','12.07.19','15.07.19',...
    '18.07.19','22.07.19','07.10.19','08.10.19','09.10.19','10.10.19','11.10.19','14.10.19','16.10.19','17.10.19','18.10.19'};
...
Behavior=table('Size',[days_nbr 40],'VariableTypes',{'string','double','double','double',...
...
for d=1:length(dates)
    ...
    Behavior(d,:)={DOI,validTrials_nbr,CubeTrial_nbr,conditionLeft_nbr,conditionCenter_nbr,conditionRight_nbr,...
        ...
        Left2right_nbr,SuccessL2R_rate,Success_day_L2R_rate};
end
