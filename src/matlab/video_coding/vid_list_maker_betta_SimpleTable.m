...
datname{1,6} = 'Success';
datname{1,7} = 'Stereotyped pulling';
datname{1,8} = 'Multiple attempts';
datname{1,9} = 'exp interv';
datname{1,10} = 'touch rake head';
datname{1,11} = 'pulled in steps';
datname{1,12} = 'Shaft correction';
datname{1,13} = 'Overshoot';
